...
**Next full Contour B matrix (owner reminder):** **1 August 2026** @ 03:00 — after Contour B catalog renames closed 2026-07-23 (`snekker`, `maskin-og-kranforer`, `platearbeider-og-sveiser`). Confirm Mac is on home IP / launchd loaded before that night.
