...
import {
  ...
  ANLEGSTEKNIKK_MATERIALIZATION_NODE_KEYS,
  KLIMA_MATERIALIZATION_NODE_KEYS,
  MURER_MATERIALIZATION_NODE_KEYS,
  ANLEGGSGARTNER_MATERIALIZATION_NODE_KEYS,
  TRETEKNIKK_MATERIALIZATION_NODE_KEYS,
  KOKK_MATERIALIZATION_NODE_KEYS,
