...
export const DEFAULT_LEBESBY_PILOT_CHARTER_ID =
  "MAIN-LOSA-PSA-WRITE-LEBESBY-2026-05-29-01";
...
export const DEFAULT_HASVIK_PILOT_CHARTER_ID =
  "MAIN-LOSA-PSA-WRITE-HASVIK-2026-05-29-01";

export const DEFAULT_BATSFJORD_PILOT_CHARTER_ID =
  "MAIN-LOSA-PSA-WRITE-BATSFJORD-2026-05-29-01";

export const DEFAULT_LOPPA_PILOT_CHARTER_ID =
  "MAIN-LOSA-PSA-WRITE-LOPPA-2026-05-29-01";

export const DEFAULT_MASOY_PILOT_CHARTER_ID =
  "MAIN-LOSA-PSA-WRITE-MASOY-2026-05-29-01";
...
export const LOSA_PSA_WRITE_CHARTER_PROFILES = {
  ...
  [DEFAULT_LEBESBY_PILOT_CHARTER_ID]: {
    deliverySite: "Lebesby",
    vilbliSchoolCode: "8874",
    snapshotLabel: "losa-lebesby-pilot-2026-05-29",
  },
  ...
  [DEFAULT_HASVIK_PILOT_CHARTER_ID]: {
    deliverySite: "Hasvik",
    vilbliSchoolCode: "8873",
    snapshotLabel: "losa-hasvik-pilot-2026-05-29",
  },
  [DEFAULT_BATSFJORD_PILOT_CHARTER_ID]: {
    deliverySite: "Båtsfjord",
    vilbliSchoolCode: "908779",
    snapshotLabel: "losa-batsfjord-pilot-2026-05-29",
  },
  [DEFAULT_LOPPA_PILOT_CHARTER_ID]: {
    deliverySite: "Loppa",
    vilbliSchoolCode: "229033",
    snapshotLabel: "losa-loppa-pilot-2026-05-29",
  },
  [DEFAULT_MASOY_PILOT_CHARTER_ID]: {
    deliverySite: "Måsøy",
    vilbliSchoolCode: "8883",
    snapshotLabel: "losa-masoy-pilot-2026-05-29",
  },
};
