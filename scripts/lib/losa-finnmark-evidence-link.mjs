                          ...
                          : deliveryScope === "delivery_site_vardo"
                            ...
                            : deliveryScope === "delivery_site_nesseby"
                              ...
                              : deliveryScope === "delivery_site_tana"
                                ...
                                : deliveryScope === "delivery_site_lebesby"
                                  ? "P4-LOSA-LEBESBY-PROGRAMME-FULL"
                                  : deliveryScope === "delivery_site_gamvik"
                                    ? "P4-LOSA-GAMVIK-PROGRAMME-FULL"
                                    : deliveryScope === "delivery_site_berlevag"
                                      ? "P4-LOSA-BERLEVAG-PROGRAMME-FULL"
                                      : deliveryScope === "delivery_site_hasvik"
                                        ? "P4-LOSA-HASVIK-PROGRAMME-FULL"
                                        : deliveryScope === "delivery_site_batsfjord"
                                          ? "P4-LOSA-BATSFJORD-PROGRAMME-FULL"
                                          : deliveryScope === "delivery_site_loppa"
                                            ? "P4-LOSA-LOPPA-PROGRAMME-FULL"
                                            : deliveryScope === "delivery_site_masoy"
                                              ? "P4-LOSA-MASOY-PROGRAMME-FULL"
                                              : deliveryScope === "delivery_site_nordkapp"
                                                ? "P4-LOSA-NORDKAPP-PROGRAMME-FULL"
                                                : deliveryScope === "delivery_site_vadso"
                                                  ? "P4-LOSA-VADSO-PROGRAMME-FULL"
