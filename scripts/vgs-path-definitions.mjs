...
function detectKlimaBranch(program) {
  ...
  if (
    title.includes("klima") ||
    title.includes("energi og miljo") ||
    title.includes("miljoteknikk") ||
    title.includes("ventilasjon") ||
    title.includes("blikkenslager") ||
    title.includes("isolator") ||
    code.includes("bakem") ||
    code.includes("bavbl") ||
    code.includes("baisl") ||
    code.includes("batak")
...
function detectMurerBranch(program) {
  ...
  if (
    title.includes("betong og mur") ||
    title.includes("mur") ||
    title.includes("betong") ||
    title.includes("flislegger") ||
    code.includes("babmo") ||
    code.includes("bamff") ||
    code.includes("babet")
  ) {
...
function detectAnleggsgartnerBranch(program) {
  ...
  if (
    title.includes("anleggsgartner") ||
    title.includes("gartner") ||
    code.includes("baang")
  ) {
...
const KLIMA_PATH_DEFINITION = {
  ...
  stageNodes: [
    ...
    },
    {
      ...
      expectedLabel: "VG2 Klima, energi og miljøteknikk",
      programmeMatcher: {
        includesAny: [
          "klima",
          "energi og miljo",
    ...
    },
    {
      ...
      requiredForWrite: false,
      expectedLabel:
        "VG3 or Opplæring i bedrift — kolonne-3 list from Vilbli for Bygg→Klima chain (not Påbygging)",
    },
    {
      nodeKey: "APPRENTICESHIP_PROGRESS",
      stage: "APPRENTICESHIP",
...
/**
 * Murer (catalog: murer / Murer og betong) — Vilbli area V.BA:
 * VG1 Bygg- og anleggsteknikk → VG2 Betong og mur → kolonne-3/bedrift.
 * Excludes other V.BA VG2 columns and Påbygging.
 */
const MURER_PATH_DEFINITION = {
  professionSlug: "murer",
  contour: "vgs",
  description:
    "Murer VGS path: VG1 Bygg- og anleggsteknikk, VG2 Betong og mur, kolonne-3/bedrift list from Vilbli.",
  sourceModel: {
    buildVilbliUrl(countySlug) {
  ...
  stageNodes: [
    ...
    },
    {
      ...
      requiredForWrite: false,
      expectedLabel:
        "VG3 or Opplæring i bedrift — kolonne-3 list from Vilbli for Bygg→Betong og mur chain (not Påbygging)",
    },
    {
      nodeKey: "APPRENTICESHIP_PROGRESS",
      stage: "APPRENTICESHIP",
...
/**
 * Anleggsgartner (catalog: anleggsgartner) — Vilbli area V.BA:
 * VG1 Bygg- og anleggsteknikk → VG2 Anleggsgartner → kolonne-3/bedrift.
 * Excludes other V.BA VG2 columns and Påbygging.
 */
const ANLEGGSGARTNER_PATH_DEFINITION = {
  professionSlug: "anleggsgartner",
  contour: "vgs",
  description:
    "Anleggsgartner VGS path: VG1 Bygg- og anleggsteknikk, VG2 Anleggsgartner, kolonne-3/bedrift list from Vilbli.",
  sourceModel: {
    buildVilbliUrl(countySlug) {
  ...
  stageNodes: [
    ...
    },
    {
      ...
      requiredForWrite: false,
      expectedLabel:
        "VG3 or Opplæring i bedrift — kolonne-3 list from Vilbli for Bygg→Anleggsgartner chain (not Påbygging)",
    },
    {
      nodeKey: "APPRENTICESHIP_PROGRESS",
      stage: "APPRENTICESHIP",
