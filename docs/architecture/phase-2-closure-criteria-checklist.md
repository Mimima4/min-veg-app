...
**Current recommended next gate from this checklist snapshot:** **Selected and recorded:** Section **Z-APPISS-post** (MAIN apply approval issuance outcome record). Outcome recording does **not** grant approval issuance, clearance, apply execution, or runtime/write approval.
...
**Separate read-only selection (2026-05-28):** Remaining blocked set still includes clearance issuance, apply approval, and runtime/write approval. Sections **Z-AP** and **Z-APC-post** prepared the apply branch; Section **Z-APPSEL** recorded explicit apply-approval branch selection; Section **Z-APPCHK** recorded separate approval-checkpoint adoption; Section **Z-APPCHK-post** recorded checkpoint outcome; Section **Z-APPISS** recorded issuance-checkpoint adoption; Section **Z-APPISS-post** recorded issuance-checkpoint outcome while keeping execution blocked.
