...
**Follow-up (2026-05-27):** Section **Z-E** framework adopted (variant A). **Operational next steps (owner selects):** gap-closure gates for G1/G2; owner-held execution charter prep; **separate** connect-approval prompt after charter; **Z-E-post** after session. Does **not** mean NOT_READY_FOR_APPLY cleared.
