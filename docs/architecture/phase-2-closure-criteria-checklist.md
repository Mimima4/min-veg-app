...
**Current recommended next gate from this checklist snapshot:** **P4-LOSA-PSA-WRITE** bounded charter (after migration apply session + per-row §4) — **not** Route/#3. **P4-LOSA-PSA** schema adopted in repo. **NOT_READY_FOR_APPLY** unchanged.

**Checklist reference note (2026-06-05):** **P4-LOSA-PSA** schema — `npm run losa:validate-psa-schema`; migration `20260605120000_programme_school_availability_losa_scope.sql`; nationwide scope; **0** LOSA PSA writes.
