...
### Dual VG1 (primary + kryssløp)

If two VG1 programmes lead to the same Contour B profession: **primary route** uses the signed home-area VG1 only; the **kryssløp** VG1 is **alternatives only** — do **not** split VG1 like VG2 columns. See `.cursor/rules/dual-vg1-primary-krysslop.mdc` and the profession-addition template § Dual VG1.
